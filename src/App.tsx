...
export default function App() {
  ...
  const handleGiveUp = () => {
    ...
    setSelectedOption(-1); // Special value to indicate skip/give up
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#e5e5e5] flex flex-col items-center py-6 sm:py-10 px-4 font-sans selection:bg-purple-500/30">
      <header className="mb-8 flex items-center space-x-3 w-full max-w-3xl border-b border-[#333333] pb-4">
        <div className="flex flex-col space-y-1">
          <span className="text-[10px] tracking-[0.3em] uppercase text-gray-500 font-bold">Live Event</span>
          <h1 className="text-3xl sm:text-4xl font-serif italic text-white flex items-center space-x-3">
            <Code2 className="w-8 h-8 text-purple-500" />
            <span>DebugMaster <span className="text-gray-600 font-sans not-italic text-2xl drop-shadow-sm">2026</span></span>
          </h1>
        </div>
      </header>
              ...
              <div className="bg-[#111111] border border-[#333333] p-6 sm:p-8 rounded-lg shadow-[0_20px_50px_rgba(0,0,0,0.5)] space-y-6">
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Test your logic through 10 tricky JavaScript debugging scenarios. The faster you spot the correct behavior, the higher your score.
                  </p>
                </div>
